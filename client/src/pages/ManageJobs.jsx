    ...
    try {
      ...
      if (data.success) {
        ...
        setAnalytics({
          ...
          activeJobs,
          totalApplications,
          avgApplicationsPerJob: jobsData.length > 0 ? Math.round(totalApplications / jobsData.length) : 0
        })
      } else {
    ...
    >
      <div className="glass rounded-2xl p-12 max-w-md">
        ...
        <p className='text-gray-600 dark:text-gray-400 mb-8'>
          Post your first job and discover amazing candidates waiting to join your team.
        </p>
        <motion.button
            ...
            {['all', 'active', 'inactive'].map((filter) => (
              ...
              >
                {filter} ({filter === 'all' ? jobs.length : 
                          filter === 'active' ? analytics.activeJobs : 
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <span className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${
                        ...
                        {job.visible ? <EyeIcon className="w-4 h-4" /> : <EyeSlashIcon className="w-4 h-4" />}
                    ...
                    <td className="px-6 py-4 text-center">
                      <motion.button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          job.visible ? 'bg-primary-500' : 'bg-gray-300 dark:bg-gray-600'
                        }`}
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                      >
