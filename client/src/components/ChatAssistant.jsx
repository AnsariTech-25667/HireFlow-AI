...
const ChatAssistant = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'ai',
      content: "Hi! I'm your AI career assistant. I can help you find jobs, analyze your resume, prepare for interviews, and provide salary guidance. How can I help you today?",
      timestamp: Date.now()
    }
  ])
  ...
  const generateAIResponse = (message, feature = null) => {
    ...
    if (message.toLowerCase().includes('salary') || message.toLowerCase().includes('negotiate')) {
