...
import { MagnifyingGlassIcon, MapPinIcon, SparklesIcon, BoltIcon, FireIcon } from '@heroicons/react/24/outline'
                    ...
                    <div className="relative z-10 py-20 text-center">
                        ...
                        >
                            ...
                            <p className='text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-3xl mx-auto px-5 leading-relaxed'>
                                ...
                                <span className="text-gradient font-semibold"> Your next opportunity</span> is just one search away.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="flex flex-wrap items-center gap-2 mt-4 px-2">
                                ...
                                {['Remote', 'Full-time', 'React Developer', 'Product Manager', 'Data Science'].map((term, index) => (
                                    <motion.button
                                        key={term}
