...
const JobCard = memo(({ job, index = 0, viewMode = 'grid' }) => {
  ...
  const getUrgencyLevel = useCallback(() => {
    ...
    if (applicants > 30) return { level: 'high', text: 'High demand', color: 'text-red-500' }
    if (applicants > 15) return { level: 'medium', text: 'Popular', color: 'text-orange-500' }
      ...
      <div className="relative z-10 h-full">
        ...
        <div className='flex justify-between items-start mb-4'>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className={`flex items-center gap-1 text-xs ${urgency.color} font-medium`}>
        ...
        <div className="mb-6">
          <p 
            ...
            dangerouslySetInnerHTML={{ 
              __html: job.description.replace(/<[^>]*>/g, '').slice(0, 120) + '...' 
            }}
          />
        </div>
        ...
        <div className="mb-6">
          <div className="flex flex-wrap gap-1.5">
            {['React', 'Node.js', 'MongoDB', 'TypeScript', 'AWS'].slice(0, 3).map((skill, skillIndex) => (
              <motion.span
                key={skill}
