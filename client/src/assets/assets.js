...
// Sample data for Manage Jobs Page - Created by Maaz Ansari
export const manageJobsData = [
    { _id: 1, title: "Full Stack Developer (MERN)", date: 1729102298497, location: "Pune", applicants: 28 },
    { _id: 2, title: "Data Scientist & ML Engineer", date: 1729102298497, location: "Bangalore", applicants: 22 },
    { _id: 3, title: "React.js Frontend Developer", date: 1729102298497, location: "Mumbai", applicants: 15 },
    { _id: 4, title: "Node.js Backend Developer", date: 1729102298497, location: "Hyderabad", applicants: 31 }
];

// Sample data for Profile Page - Demo applications by Maaz Ansari
export const jobsApplied = [
    {
        company: 'Netraket (Skuad)',
...
export const viewApplicationsPageData = [
    { _id: 1, name: "Maaz Ansari", jobTitle: "Full Stack Developer (MERN)", location: "Pune", imgSrc: profile_img },
    { _id: 2, name: "Arjun Patel", jobTitle: "Data Scientist & ML Engineer", location: "Bangalore", imgSrc: profile_img },
    { _id: 3, name: "Priya Sharma", jobTitle: "React.js Frontend Developer", location: "Mumbai", imgSrc: profile_img },
    { _id: 4, name: "Rohit Kumar", jobTitle: "Node.js Backend Developer", location: "Hyderabad", imgSrc: profile_img },
    { _id: 5, name: "Sneha Reddy", jobTitle: "DevOps Engineer", location: "Chennai", imgSrc: profile_img },
    { _id: 6, name: "Amit Singh", jobTitle: "UI/UX Designer", location: "Delhi", imgSrc: profile_img },
    { _id: 7, name: "Kavya Nair", jobTitle: "Python Developer", location: "Kochi", imgSrc: profile_img },
];
